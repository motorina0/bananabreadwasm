...
;(function (qrcodegen) {
  ...
  var QrCode = /** @class */ (function () {
    ...
    QrCode.encodeSegments = function (
      ...
      for (
        var _i = 0,
          _a = [QrCode.Ecc.MEDIUM, QrCode.Ecc.QUARTILE, QrCode.Ecc.HIGH];
        _i < _a.length;
        _i++
      ) {
        // From low to high
...
window.BananaBread_QR_DATA_URI = function (value) {
  ...
  const svg =
    ...
    ' ' +
    size +
    '" shape-rendering="crispEdges"><path fill="#fff" d="M0 0h' +
    size +
    'v' +
    size +
    'H0z"/><path fill="#000" d="' +
